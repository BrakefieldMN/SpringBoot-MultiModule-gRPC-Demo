...
public final class StreamingGreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.brakefield.grpc.library.HelloRequest,
      com.brakefield.grpc.library.HelloReply> getSayHelloStreamingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHelloStreaming",
      requestType = com.brakefield.grpc.library.HelloRequest.class,
      responseType = com.brakefield.grpc.library.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.brakefield.grpc.library.HelloRequest,
      com.brakefield.grpc.library.HelloReply> getSayHelloStreamingMethod() {
    io.grpc.MethodDescriptor<com.brakefield.grpc.library.HelloRequest, com.brakefield.grpc.library.HelloReply> getSayHelloStreamingMethod;
      ...
      synchronized (StreamingGreeterGrpc.class) {
        if ((getSayHelloStreamingMethod = StreamingGreeterGrpc.getSayHelloStreamingMethod) == null) {
          StreamingGreeterGrpc.getSayHelloStreamingMethod = getSayHelloStreamingMethod = 
              io.grpc.MethodDescriptor.<com.brakefield.grpc.library.HelloRequest, com.brakefield.grpc.library.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "manualflowcontrol.StreamingGreeter", "SayHelloStreaming"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.brakefield.grpc.library.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.brakefield.grpc.library.HelloReply.getDefaultInstance()))
  ...
  public static abstract class StreamingGreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.brakefield.grpc.library.HelloRequest> sayHelloStreaming(
        io.grpc.stub.StreamObserver<com.brakefield.grpc.library.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.brakefield.grpc.library.HelloRequest,
                com.brakefield.grpc.library.HelloReply>(
  ...
  private static abstract class StreamingGreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.brakefield.grpc.library.HelloStreamingProto.getDescriptor();
    }
